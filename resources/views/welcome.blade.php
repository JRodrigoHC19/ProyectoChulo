...
<body class="antialiased">
    ...
    <nav id="dezliz-sombra" class="desliz-sombrita navbar navbar-expand-lg fixed-top bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ url('/') }}">Booking Hive</a>
            <button id="autoButton" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <!-- ESTE EL APARTADO QUE MUESTRA EL CONTENIDO - LO MUESTRAS SIN IMPORTAR QUE ESTES LOGEADO -->
